        ...
        <div class="container">
            ...
            <div class="row">
                @foreach($members as $member)
                    <div class="col-sm-4">
                        <div class="team-member">
                            <a href="{{ $member->name }}" data-toggle="modal" data-target="#member{{ $member->id }}"><img src="{{ $member->images->first()->path . $member->images->first()->name }}" class="img-responsive img-circle" alt="" style="height: 239px; width:239px;"></a>
