	                ...
	                <div class="col-md-4 card_blog">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <img src="{{ url($imagePath) }}" class="img-responsive img-rounded" alt="{{ $imageName }}" style="height:260px; width:360px;">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12">
                                        <a href="{{ $post->slug }}" data-toggle="modal" data-target="#{{ $post->slug }}" data-link="{{ url($imagePath) }}" class="blog-modal-link">
